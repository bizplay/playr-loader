...
# NOTE: for Chromium the location of the Preferences file is ~/.config/chromium/Default/Preferences
sed -i 's/exit_type\"\:\"Crashed/exit_type\"\:\"Normal/g' ~/.config/google-chrome/Default/Preferences
sed -i 's/exit_type\"\:\"SessionEnded/exit_type\"\:\"Normal/g' ~/.config/google-chrome/Default/Preferences
sed -i 's/exited_cleanly\"\:false/exited_cleanly\"\:true/g' ~/.config/google-chrome/Default/Preferences
...
$browser ${gpu_options} ${persistency_options} ${no_nagging_options} --kiosk "file://"${playr_loader_file}"?channel="${channel}"&reload_url="${reload_url}
